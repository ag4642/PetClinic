...
public class ClinicServiceImpl implements ClinicService {
	...
	public ClinicServiceImpl(PetRepository petRepository, VetRepository vetRepository, OwnerRepository ownerRepository,
			VisitRepository visitRepository, SupplyRepository supplyRepository) {
	...
	@Override
	public void unassignVet(Integer visitId) throws DataAccessException {
		visitRepository.unassign(visitId);
	}

	@Override
	public void markPaid(Integer visitId, Boolean b) throws DataAccessException {
		visitRepository.paid(visitId, b);

	}

	@Override
	public Collection<Supply> findSupplies() throws DataAccessException {
		return supplyRepository.findAllSupplies();
	}
	...
	@Override
	public void saveSupply(Supply supply) throws DataAccessException {
